...
InSpec profile overlay to validate the secure configuration of NGINX
based on [DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) Apache
2.2 Server tailored for [CMS ARS
...
[issue](https://github.cms.gov/ISPG/cms-ars-3.1-moderate-nginx-overlay/issues).
...
https://iase.disa.mil/Pages/privacy\_policy.aspx
